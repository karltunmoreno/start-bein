...
const DonateList = ({ category }) => {
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [currentPhoto, setCurrentPhoto] = useState();
  const [photos] = useState([
    {
      name: 'Eco Non Profit A',
      category: 'carbon',
      description:
        'Eco Non Profit A helps reduce your energy use'
    },
    {
      name: 'Eco Non Profit B',
      category: 'bees',
      description:
        'Eco Non Profit B helps prevent bees colony collapse'
    },
